...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        if(homeGoals==-1 || awayGoals == -1){
            view.setContentDescription(context.getString(R.string.a11y_game_info_no_scores,
                    homeTeam, awayTeam));
        }else {
            view.setContentDescription(context.getString(R.string.a11y_game_info, homeTeam,
